...
<div class="panel">
    ...
    <div class="panel-body"> 
        <div class=" ">
            <div class="icon">
                <a href="<?php echo Router::buildLink('permission', array("view"=>'resource')) ?>">
            ...
            <div class="icon">
                <a href="<?php echo Router::buildLink('permission', array("view"=>'users')) ?>">
                    <img alt="Role" src="/images/icons/users.png">
                    <span>Grant Users</span>
                </a>
            </div>
            
            <div class="icon">
                <a href="<?php echo Router::buildLink('permission', array("view"=>'groups')) ?>">
                    <img alt="Role" src="/images/icons/groups.png">
                    <span>Grant Groups</span>
                </a>
            </div>
            
            <div class="icon">
                <a href="<?php echo Router::buildLink('permission', array("view"=>'about')) ?>">
