...
<form name="adminForm" method="post" action="">
    <div class='items-tree user-tree'>
        <?php
        showNodeTree($items, $items_status, $all_granted);
        ?> 
    </div> 
    <?php
    ...
    ?>
    <input type="hidden" name="id" value="<?php echo Request::getVar('cid',0) ?>"/>
...
<?php function showNodeTree($items, $items_status, $all_granted, $level = 0)
{
    $class = $level >1?"line":"";
    echo '<ul class="'.$class.'">';    
        $k = 0; 
